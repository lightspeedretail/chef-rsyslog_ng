...
default[:rsyslog_ng][:modules] = Hash.new
default[:rsyslog_ng][:modules]["imklog"] = {}
default[:rsyslog_ng][:modules]["imklog"].tap do |config|
  config["load"]   = "imklog"
end


default[:rsyslog_ng][:modules]["imuxsock"] ||= {}
...
default[:rsyslog_ng][:modules]["omrelp"] ||= {}
default[:rsyslog_ng][:modules]["omrelp"].tap do |config|
  config["load"]            = "omrelp"
end

default[:rsyslog_ng][:modules]["omfile"] ||= {}
